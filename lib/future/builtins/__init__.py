...
from lib.future.builtins.iterators import (filter, map, zip)
...
from lib.future.builtins.misc import (ascii, chr, hex, input, isinstance, next,
                                  oct, open, pow, round, super, max, min)
from lib.future.utils import PY3
...
if PY3:
    ...
    from lib.future.types import (newbytes as bytes,
                              newdict as dict,
                              newint as int,
                              newlist as list,
                              newobject as object,
